...
const SEED_DOMAINS = {
  ...
  // dMRV layer health checks
  'dmrv:sensor-community':   { key: 'seed-meta:dmrv:sensor-community',   intervalMin: 30 },
  'dmrv:opensensemap':       { key: 'seed-meta:dmrv:opensensemap',       intervalMin: 30 },
  'dmrv:emsc-earthquakes':   { key: 'seed-meta:dmrv:emsc-earthquakes',   intervalMin: 10 },
  'dmrv:noaa-buoys':         { key: 'seed-meta:dmrv:noaa-buoys',         intervalMin: 60 },
  'dmrv:flood-monitoring':   { key: 'seed-meta:dmrv:flood-monitoring',   intervalMin: 15 },
  'dmrv:usgs-water':         { key: 'seed-meta:dmrv:usgs-water',         intervalMin: 15 },
  'dmrv:greynoise':          { key: 'seed-meta:dmrv:greynoise',          intervalMin: 60 },
  'dmrv:grid-status':        { key: 'seed-meta:dmrv:grid-status',        intervalMin: 5  },
  'dmrv:open-meteo':         { key: 'seed-meta:dmrv:open-meteo',         intervalMin: 30 },
  'dmrv:uk-carbon':          { key: 'seed-meta:dmrv:uk-carbon',          intervalMin: 30 },
  'dmrv:danish-energi':      { key: 'seed-meta:dmrv:danish-energi',      intervalMin: 30 },
  'dmrv:gruenstrom':         { key: 'seed-meta:dmrv:gruenstrom',         intervalMin: 60 },
  'dmrv:opensky':            { key: 'seed-meta:dmrv:opensky',            intervalMin: 10 },
  'dmrv:noaa-ngdc':          { key: 'seed-meta:dmrv:noaa-ngdc',          intervalMin: 60 },
  'dmrv:uv-index':           { key: 'seed-meta:dmrv:uv-index',           intervalMin: 60 },
  'dmrv:pm25-lass':          { key: 'seed-meta:dmrv:pm25-lass',          intervalMin: 30 },
  'dmrv:openfema':           { key: 'seed-meta:dmrv:openfema',           intervalMin: 60 },
  'dmrv:open-charge':        { key: 'seed-meta:dmrv:open-charge',        intervalMin: 120 },
  'dmrv:luchtmeetnet':       { key: 'seed-meta:dmrv:luchtmeetnet',       intervalMin: 30 },
  'dmrv:gdacs':              { key: 'seed-meta:dmrv:gdacs',              intervalMin: 15 },
  ...
  'dmrv:gbif-biodiversity':   { key: 'seed-meta:dmrv:gbif-biodiversity',   intervalMin: 360 },
  ...
  'dmrv:open-meteo-air-quality': { key: 'seed-meta:dmrv:open-meteo-air-quality', intervalMin: 60 },
  'dmrv:open-meteo-marine':      { key: 'seed-meta:dmrv:open-meteo-marine',      intervalMin: 60 },
  'dmrv:worms-marine-species':   { key: 'seed-meta:dmrv:worms-marine-species',   intervalMin: 1440 },
  'dmrv:tle-satellites':         { key: 'seed-meta:dmrv:tle-satellites',         intervalMin: 360 },
  'dmrv:restor-eco':             { key: 'seed-meta:dmrv:restor-eco',             intervalMin: 1440 },
  'dmrv:silvi-earth':            { key: 'seed-meta:dmrv:silvi-earth',            intervalMin: 360 },
  'dmrv:xeno-canto':             { key: 'seed-meta:dmrv:xeno-canto',             intervalMin: 360 },
  'dmrv:naturemapr':             { key: 'seed-meta:dmrv:naturemapr',             intervalMin: 360 },
  'dmrv:spotteron':              { key: 'seed-meta:dmrv:spotteron',              intervalMin: 60 },
  'dmrv:plantnet':               { key: 'seed-meta:dmrv:plantnet',               intervalMin: 1440 },
  'dmrv:citsci':                 { key: 'seed-meta:dmrv:citsci',                 intervalMin: 360 },
  'dmrv:ebird':                  { key: 'seed-meta:dmrv:ebird',                  intervalMin: 360 },
  'dmrv:observation-org':        { key: 'seed-meta:dmrv:observation-org',        intervalMin: 360 },
  'dmrv:guardiansofearth':       { key: 'seed-meta:dmrv:guardiansofearth',       intervalMin: 60 },
  ...
  'dmrv:surftruths-buoys':        { key: 'seed-meta:dmrv:surftruths-buoys',        intervalMin: 60 },
  'dmrv:surftruths-tide-stations': { key: 'seed-meta:dmrv:surftruths-tide-stations', intervalMin: 1440 },
  'dmrv:surftruths-gfs-locations': { key: 'seed-meta:dmrv:surftruths-gfs-locations', intervalMin: 360 },
  'dmrv:websitecarbon-data':       { key: 'seed-meta:dmrv:websitecarbon-data',       intervalMin: 1440 },
  'dmrv:earth-engine':             { key: 'seed-meta:dmrv:earth-engine',             intervalMin: 1440 },
