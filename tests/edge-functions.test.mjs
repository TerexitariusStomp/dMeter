...
describe('Legacy api/*.js endpoint allowlist', () => {
  const ALLOWED_LEGACY_ENDPOINTS = new Set([
    ...
    'bootstrap.js',
    'bcorp-map.js',
    'bonsucro-registry.js',
    'breeam-map.js',
    'cache-purge.js',
    'change-climate-brands.js',
    'contact.js',
    'download.js',
    'earthcheck-members.js',
    'energystar-buildings.js',
    'fwdstart.js',
    'geo.js',
    'gpsjam.js',
    'green-destinations.js',
    'gstc-certified-destinations.js',
    'health.js',
    'military-flights.js',
    'natural-capital-map.js',
    'og-story.js',
    'opensky.js',
    'oref-alerts.js',
    'polymarket.js',
    'product-catalog.js',
    'realorganic-farms.js',
    'register-interest.js',
    'reverse-geocode.js',
    'mcp-proxy.js',
    'rodale-organic-farms.js',
    'rss-proxy.js',
