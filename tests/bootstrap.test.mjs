...
describe('Bootstrap key hydration coverage', () => {
  it('every bootstrap key has a getHydratedData consumer in src/', () => {
    ...
    const PENDING_CONSUMERS = new Set([
      ...
      'dmrvUsdaOrganicOperations', 'changeClimateBrands',
      'censorshipDomainCategories', 'energystarBuildings',
      'realorganicFarms', 'rodaleOrganicFarms',
      // dMRV datasets — panels not yet wired to getHydratedData consumers
      'dmrv7timerForecast', 'dmrvAareRiver', 'dmrvAdresseGeocode', 'dmrvApiStatusCheck',
      'dmrvAviationweather', 'dmrvCitsci', 'dmrvCopernicusAtmos', 'dmrvCurrentuv',
      'dmrvDanishEnergi', 'dmrvDwdWeather', 'dmrvEarthEngine', 'dmrvEbird',
      'dmrvEmscEarthquakes', 'dmrvEnergyCharts', 'dmrvFloodMonitoring',
      'dmrvGbifBiodiversity', 'dmrvGdacs', 'dmrvGlobalFloodApi', 'dmrvGreynoise',
      'dmrvGridStatus', 'dmrvGruenstrom', 'dmrvGuardiansofearth', 'dmrvHkoWeather',
      'dmrvInaturalist', 'dmrvIntentionalCommunities', 'dmrvLuchtmeetnet',
      'dmrvMetnoForecast', 'dmrvNasaOpen', 'dmrvNasaPower', 'dmrvNaturemapr',
      'dmrvNaturespots', 'dmrvNoaaBuoys', 'dmrvNoaaNgdc', 'dmrvNoaaNwsAlerts',
      'dmrvNoaaNwsForecast', 'dmrvNominatimGeocode', 'dmrvObisMarine',
      'dmrvObservationOrg', 'dmrvOpenCharge', 'dmrvOpenElevation', 'dmrvOpenfema',
      'dmrvOpenMeteo', 'dmrvOpenMeteoAirQuality', 'dmrvOpenMeteoMarine',
      'dmrvOpenNotifyIss', 'dmrvOpenSenseMap', 'dmrvOpenSky', 'dmrvOpentopodata',
      'dmrvOverpassOsm', 'dmrvPlantnet', 'dmrvPm25Lass', 'dmrvPurpleair',
      'dmrvRainviewer', 'dmrvReeflifesurvey', 'dmrvRestorEco', 'dmrvSensorCommunity',
      'dmrvSgWeather', 'dmrvSilviEarth', 'dmrvSpotteron', 'dmrvSurftruthsBuoys',
      'dmrvSurftruthsGfsLocations', 'dmrvSurftruthsTideStations', 'dmrvTleSatellites',
      'dmrvUkCarbon', 'dmrvUsgsQuakes', 'dmrvUsgsWater', 'dmrvUvIndex',
      'dmrvWebsitecarbonData', 'dmrvWormsMarineSpecies', 'dmrvWttrWeather',
      'dmrvXenoCanto',
    ]);
    for (const key of keys) {
