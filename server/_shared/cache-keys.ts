...
export const BOOTSTRAP_TIERS: Record<string, 'slow' | 'fast'> = {
  ...
  dmrvOverpassOsm: 'slow', dmrvNominatimGeocode: 'slow', dmrvIntentionalCommunities: 'slow',
