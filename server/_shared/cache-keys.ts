...
export const BOOTSTRAP_CACHE_KEYS: Record<string, string> = {
  ...
  dmrvAviationweather: 'dmrv:aviationweather:v1',
  ...
  censorshipDomainCategories: 'intelligence:censorship-domain-categories:v1',
  ...
  realorganicFarms: 'agriculture:realorganic-farms-bootstrap:v1',
  rodaleOrganicFarms: 'agriculture:rodale-organic-farms-bootstrap:v1',
...
export const BOOTSTRAP_TIERS: Record<string, 'slow' | 'fast'> = {
  ...
  climateAnomalies: 'slow', climateDisasters: 'slow', co2Monitoring: 'slow', oceanIce: 'slow', climateNews: 'slow', sanctionsPressure: 'slow', radiationWatch: 'slow', crossSourceSignals: 'slow', cyberThreats: 'slow', techReadiness: 'slow',
  naturalEvents: 'slow',
  ...
  dmrvOpenCharge: 'slow', dmrvLuchtmeetnet: 'slow', dmrvEnergyCharts: 'slow', dmrvCopernicusAtmos: 'slow', dmrvPurpleair: 'slow',
  dmrvCurrentuv: 'slow',
  dmrvGbifBiodiversity: 'slow', dmrvObisMarine: 'slow', dmrvOpentopodata: 'slow',
  dmrvAdresseGeocode: 'slow',
  dmrvNasaOpen: 'slow', dmrvNasaPower: 'slow', dmrvOpenElevation: 'slow',
  dmrvWormsMarineSpecies: 'slow', dmrvTleSatellites: 'slow',
  dmrvRestorEco: 'slow', dmrvSilviEarth: 'slow', dmrvXenoCanto: 'slow', dmrvNaturemapr: 'slow', dmrvPlantnet: 'slow', dmrvCitsci: 'slow', dmrvReeflifesurvey: 'slow',
  dmrvOverpassOsm: 'slow', dmrvNominatimGeocode: 'slow', dmrvIntentionalCommunities: 'slow', dmrvSurftruthsTideStations: 'slow', dmrvWebsitecarbonData: 'slow', dmrvEarthEngine: 'slow',
  cryptoQuotes: 'slow', gulfQuotes: 'slow', stablecoinMarkets: 'slow',
  unrestEvents: 'slow', techEvents: 'slow',
  ...
  natcapMapData: 'slow',
  bcorpMapData: 'slow',
  bonsucroRegistry: 'slow',
  greenDestinations: 'slow',
  gstcCertifiedDestinations: 'slow',
  earthcheckMembers: 'slow',
  epicNaturalImagery: 'slow',
  openMeteoWeather: 'fast',
  openAQAirQuality: 'fast',
  worldbankIndicators: 'slow',
  maritimeAISPositions: 'fast',
  nasaFireDetections: 'fast',
  spaceOrbitalObjects: 'fast',
  ...
  wwoofHosts: 'slow',
  breeamMapData: 'slow',
  realorganicFarms: 'slow',
  rodaleOrganicFarms: 'slow',
  changeClimateBrands: 'slow',
  sitesProjects: 'slow',
  energystarBuildings: 'slow',
  dmrvUsdaOrganicOperations: 'slow',
};
