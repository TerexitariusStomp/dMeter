...
export const BOOTSTRAP_TIERS: Record<string, 'slow' | 'fast'> = {
  ...
  dmrvOpenSky: 'fast', dmrvGdacs: 'fast', dmrvUsgsQuakes: 'fast', dmrvAviationweather: 'fast', dmrvRainviewer: 'fast', dmrv7timerForecast: 'fast', dmrvMetnoForecast: 'fast', dmrvAareRiver: 'fast', dmrvApiStatusCheck: 'fast', dmrvNoaaNwsAlerts: 'fast', dmrvOpenNotifyIss: 'fast',
  ...
  dmrvNasaOpen: 'slow', dmrvNasaPower: 'slow',
