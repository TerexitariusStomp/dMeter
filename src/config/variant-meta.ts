...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'dMeter — Real-Time dMRV & Environmental Dashboard',
    description: 'Real-time environmental monitoring, dMRV data, climate intelligence, and natural resource tracking. Open environmental data in one view.',
    keywords: 'dMRV, environmental monitoring, climate data, carbon tracking, biodiversity, natural resources, earth observation, reforestation, conservation, sustainability, open data, geospatial, satellite imagery',
    url: 'https://dmeter.templeearth.cc/',
    siteName: 'dMeter',
    shortName: 'dMeter',
    subject: 'Real-Time Environmental Monitoring and dMRV Data',
    classification: 'Environmental Dashboard, dMRV Platform, Climate Data Aggregator',
