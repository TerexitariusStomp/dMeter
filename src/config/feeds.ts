...
export const DEFAULT_ENABLED_SOURCES: Record<string, string[]> = {
  ...
  africa: ['BBC Africa', 'News24', 'Africanews', 'Jeune Afrique', 'Africa News', 'Premium Times', 'Channels TV'],
  latam: ['BBC Latin America', 'Reuters LatAm', 'Mexico News Daily', 'Clarín', 'Primicias', 'Infobae Americas', 'El Universo'],
