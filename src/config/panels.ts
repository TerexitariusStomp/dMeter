...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  marketsFinance: {
    ...
    panelKeys: ['commodities', 'energy-complex', 'markets', 'economic', 'trade-policy', 'supply-chain', 'finance', 'polymarket', 'macro-signals', 'gulf-economies', 'etf-flows', 'stablecoins', 'crypto', 'heatmap'],
    variants: ['full'],
  },
  topical: {
  ...
  centralBanksEcon: {
    ...
    panelKeys: ['centralbanks', 'economic', 'energy-complex', 'trade-policy', 'supply-chain', 'economic-news'],
    variants: ['finance'],
  },
  dealsInstitutional: {
